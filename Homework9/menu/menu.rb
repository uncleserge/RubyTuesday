...
class Menu
  def initialize(jack)
    ...
    wagon_man = root.add_child(MenuNode.new('Wagon management'))
    wagon_man.add_child(MenuNode.new('Attach wagon to train', :attach_wagon))
    wagon_man.add_child(MenuNode.new('Detach wagon from train', :detach_wagon))
    wagon_man.add_child(MenuNode.new('Fill cargo wagon', :fill_cargo_wagon))
    wagon_man.add_child(MenuNode.new('Take seat at wagon', :take_seat_at_wagon))
    ...
    report.add_child(MenuNode.new('Trains list with wagons', :show_all_trains_with_wagons))
